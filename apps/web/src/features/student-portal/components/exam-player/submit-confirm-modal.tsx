    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4">
      <Card className="rounded-2xl border border-border shadow-xl max-w-md w-full animate-in zoom-in-95 duration-150">
        <CardContent className="p-6 text-center">
          <div className="flex size-12 items-center justify-center rounded-full bg-sky-50 dark:bg-sky-950/50 text-sky-600 dark:text-sky-400 mx-auto mb-4">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button
              className="flex-1 rounded-xl font-bold gap-1.5 bg-sky-600 hover:bg-sky-700 text-white"
              onClick={onSubmit}
              disabled={isPending}
            >
