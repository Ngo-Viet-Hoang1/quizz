        ...
        <CardContent className="p-4 sm:p-5">
              ...
              return (
                <button
                  ...
                  className={`flex size-10 items-center justify-center rounded-xl text-xs font-bold transition-all cursor-pointer relative ${
                    isAnswered
                      ? 'bg-sky-50 border border-sky-200 text-sky-700 dark:bg-sky-950/40 dark:border-sky-900 dark:text-sky-300 hover:bg-sky-100/70'
          ...
          <div className="mt-4 pt-3 border-t border-border/60 space-y-2.5 text-xs font-medium text-muted-foreground">
            <div className="flex items-center gap-2.5">
              <span className="size-4 rounded-md bg-sky-50 border border-sky-200 dark:bg-sky-950/40 dark:border-sky-900 shrink-0" />
              <span>Answered</span>
            </div>
            <div className="flex items-center gap-2.5">
          ...
          <div className="mt-4 pt-3 border-t border-border/60">
            <Button
              ...
              className="w-full h-11 rounded-xl font-bold gap-2 bg-sky-600 hover:bg-sky-700 text-white shadow-xs transition-all"
            >
